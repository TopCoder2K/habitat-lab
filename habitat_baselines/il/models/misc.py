...
def collate_fn(do_round, batch):
    ...
    #     # Since in general each batch element will have
    #     # a different number of boxes, we collapse a single batch dimension
    #     # to avoid padding. This is sufficient for our purposes.
